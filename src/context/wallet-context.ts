...
export function useWalletContextValue(): WalletContextData {
  ...
  const [_bankWallet, setBankWallet] = useState<CardWallet>();
  ...
  const [_transactionChannel, setTransactionChannels] = useState<
    TransactionChannel[]
  >([]);
