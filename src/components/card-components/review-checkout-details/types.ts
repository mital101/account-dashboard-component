...
export type ReviewCheckoutDetailsComponentProps = {
  style?: ReviewCheckoutDetailsComponentStyles;
  props: {
    onConfirm: () => void;
    isShowCancelAlert: boolean;
...
export type ReviewCheckoutDetailsComponentStyles = {
