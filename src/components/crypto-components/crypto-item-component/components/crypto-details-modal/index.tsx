...
export type CryptoDetailsModalProps = {
  isVisible: boolean;
  wallet: Wallet;
  onClose: () => void;
  phoneNumber: string;
  style?: CryptoDetailsModalStyles;
};

export type CryptoDetailsModalStyles = {
...
const CryptoDetailsModal = ({
  ...
  const styles: CryptoDetailsModalStyles = useMergeStyles(style);
