...
const CryptoTransactionsCardComponent = ({style, props}: CryptoTransactionsCardComponentProps) => {
  const {data, isLastItem, isFirstItem, onSelect} = props || {};
  const styles = useMergeStyles(style);

  return (
    <TouchableOpacity style={[styles.container, isFirstItem && styles.borderRadiusTop, isLastItem && styles.borderRadiusBottom]} onPress={() => onSelect ? onSelect(data.id) : true}>
