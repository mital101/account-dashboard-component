...
import CountdownTimer, { CountDownTimerRef } from 'react-native-theme-component/src/countdown-timer';

const CryptoVerifyOTPComponent = ({ props, style }: CryptoVerifyOTPComponentProps) => {
