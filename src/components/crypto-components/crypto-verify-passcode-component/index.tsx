import { CryptoVerifyPasscodeComponentProps } from './types';
...
const CryptoVerifyPasscodeComponent = ({ props, style }: CryptoVerifyPasscodeComponentProps) => {
    ...
    return (
      <SafeAreaView style={styles.safeArea}>
        <ScrollView showsVerticalScrollIndicator={false}  style={styles.container}>
            <Text style={styles.pageTitle}>{'Please enter the in-app passcode'}</Text>
            ...
            <View style={styles.content}>
             <OTPField 
              ...
              <View style={styles.rowCenter}>
                <TouchableOpacity style={styles.receiveOTPOptionBtn} onPress={onSwitchToVerifyOTP}>
                  <Text style={styles.receiveOTPOptionLabel}>Receive OTP via SMS</Text>
                </TouchableOpacity>
              </View>
            </View>
        </ScrollView>
        ...
        <PasscodeModal isVisible={isShowPasscodeModel} onClose={onClosePasscodeModel} passcode={'327891'} />
      </SafeAreaView>
    );
  };

export default CryptoVerifyPasscodeComponent;
