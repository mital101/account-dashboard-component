...
const useMergeStyles = (style?: PasscodeModalStyles): PasscodeModalStyles => {
  ...
  const defaultStyles: PasscodeModalStyles = StyleSheet.create({
    ...
    header: {flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingTop: 15},
    closeTitle: {
    ...
    btnCancel: {borderColor: colors.primaryButtonColor, borderWidth: 1, marginTop: 10},
