...
const CryptoTransactionPostingComponent = ({ props, style }: CryptoTransactionPostingComponentProps) => {
    ...
    if(isLoading) {
      return <View style={styles.containerCenter}>
        ...
        <View style={styles.subTitleWrapper}>
          <Text style={styles.subTitle}>We’re currently setting up your transaction.</Text>
        </View>
    ...
    if(!isSuccess) {
      return <View style={styles.containerFailed}>
        <View style={styles.errorContentWrapper}>
          ...
          <View style={styles.errorTitleWrapper}>
              ...
              <View style={styles.errorMessageWrapper}>
                <Text style={styles.errorMessageLabel}>We’ve encountered a problem with your transaction. Your crypto has been returned to your crypto pitaka. Please try again later.</Text>
              </View>
            </View>
            <View style={styles.rowErrorBetween}>
              <Text style={[styles.infoTitle, styles.errorInfoTitleColor]}>Reference No.</Text>
              <Text style={[styles.infoSubTitle, styles.errorInfoTitleColor]}>ABCDE12345676789</Text>
            </View>
          </View>
          </View>
        </View>
        <View>
          <Button label={'Back to Crypto Dashboard'} onPress={onBackToDashboard} />
          <Button label={'Have issues? Visit our Help Center!'} onPress={onGoToHelpCenter} bgColor={'transparent'} style={{
     ...
     <View style={styles.container}>
      ...
      <Text style={styles.titleSuccess}>Transaction Successful!</Text>
        <View style={styles.subTitleSuccessWrapper}>
          <Text style={styles.subTitleSuccess}>#UDidIt! You have successfully transferred money from your Pitaka to your Crypto Pitaka. See transaction details below:</Text>
        </View>
        ...
        <View style={styles.btnActionsWrapper}>
          <Button label={'Make Another Transaction'} onPress={onBackToTransferIn} />
          <Button label={'Back to Crypto Dashboard'} onPress={onBackToDashboard} bgColor={'transparent'} style={{
            primaryContainerStyle: styles.btnTransparent,
            primaryLabelStyle: styles.labelBtnTransaprent
          }} />
        </View>
